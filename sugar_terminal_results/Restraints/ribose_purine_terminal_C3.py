RIBOSE_PURINE_TERMINAL_C3_PDB_CODES = ['A', 'G', 'IG']
...
RIBOSE_PURINE_TERMINAL_C3_BASE_FUNC_OF_TORSION_CHI_RESTRAINTS = [
    {
        ...
        'restraints': [['angle', "aC4'C5'O5'", ["C4'", "C5'", "O5'"], None, None, None, None, "purine-C4'-C5'-O5'.joblib", ['torsion_chi', ["O4'", "C1'", 'N9', 'C4']]]]
    }
]
...
RIBOSE_PURINE_TERMINAL_C3_SUGAR_CONFORMATION_RESTRAINTS = [
    ...
    {
        'conditions': [], 'name': 'ribose_purine_terminal_C3==Sugar=ribose__Conformation=Other', 'restraints': [['dist', "dC3'O3'", ["C3'", "O3'"], 1.418, 0.004]]
    }
]
...
RIBOSE_PURINE_TERMINAL_C3_ALL_FUNC_OF_TORSION_CHI_RESTRAINTS = [
    {
        ...
        'restraints': [['angle', "aC4'C5'O5'", ["C4'", "C5'", "O5'"], None, None, None, None, "All-C4'-C5'-O5'.joblib", ['torsion_chi', ["O4'", "C1'", 'N9', 'C4']]]]
    }
]