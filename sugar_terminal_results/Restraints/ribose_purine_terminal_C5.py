RIBOSE_PURINE_TERMINAL_C5_PDB_CODES = ['A', 'G', 'IG']
...
RIBOSE_PURINE_TERMINAL_C5_ALL_FUNC_OF_TORSION_CHI_RESTRAINTS = [
    {
        'conditions': [],
        'name': 'ribose_purine_terminal_C5==All=All',
        'restraints': [   ['angle', "aC1'C2'O2'", ["C1'", "C2'", "O2'"], None, None, None, None, "All-C1'-C2'-O2'.joblib", ['torsion_chi', ["O4'", "C1'", 'N9', 'C4']]],
                          ['angle', "aC3'C2'O2'", ["C3'", "C2'", "O2'"], None, None, None, None, "All-C3'-C2'-O2'.joblib", ['torsion_chi', ["O4'", "C1'", 'N9', 'C4']]],
                          ['angle', "aC2'C3'O3'", ["C2'", "C3'", "O3'"], None, None, None, None, "All-C2'-C3'-O3'.joblib", ['torsion_chi', ["O4'", "C1'", 'N9', 'C4']]]]
    }
]